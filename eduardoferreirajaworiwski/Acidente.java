...
public class Acidente {
  ...
  public void cadastra(Rodovia rodovia) {
    setRodovia(rodovia);
    setVitimasFatais(Integer.parseInt(JOptionPane.showInputDialog(null, "Quantidade de vitimas fatais no acidente")));

    int qntVeiculos = Integer
        .parseInt(JOptionPane.showInputDialog(null, "Quantidade de veículos que se envolveram no acidente"));
