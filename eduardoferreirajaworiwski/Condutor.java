...
public class Condutor {
  ...
  public void cadastra() {
    setNome((JOptionPane.showInputDialog(null, "Nome do condutor ")));
    setIdade(Integer.parseInt(JOptionPane.showInputDialog(null, "Digite a idade do condutor " + getNome())));
    setSexo(
        JOptionPane.showInputDialog(null, "Sexo do condutor " + getNome() + " (M/F)").toUpperCase().charAt(0));
    setEmbriagado((JOptionPane.showInputDialog(null, "O condutor "+ getNome() +" estava embriagado? (1/0)").charAt(0)));
  }
